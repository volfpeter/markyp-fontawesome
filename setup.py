...
with open(
    path.join(path.abspath(path.dirname(__file__)), ROOT, "__init__.py"),
    encoding="utf-8",
) as f:
    content = f.read()
...
setup(
    ...
    keywords="fontawesome font awesome html icon markup generator utility",
